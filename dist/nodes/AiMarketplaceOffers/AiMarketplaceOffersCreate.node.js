...
exports.AiMarketplaceOffersCreate = void 0;
const n8n_workflow_1 = require("n8n-workflow");
class AiMarketplaceOffersCreate {
    constructor() {
        this.description = {
            displayName: 'Marketplace Offers: Create',
            name: 'aiMarketplaceOffersCreate',
            icon: 'file:aimarketplace.svg',
            group: ['output'],
            version: 1,
            subtitle: '=Create offer',
            description: 'Create a new offer on a lot',
            defaults: {
            ...
            properties: [
                ...
                },
                {
                    ...
                    required: true,
                    default: '',
                    description: 'The ID of the lot to make an offer on',
                },
                {
                    displayName: 'Amount',
                    name: 'amount',
                    ...
                    description: 'Offer amount (minimum 0)',
                },
                {
                    displayName: 'Comment',
                    name: 'comment',
                    ...
                    description: 'Optional comment on the offer (max 512 characters)',
                },
                {
                    displayName: 'Timeout',
                    name: 'timeout',
...
exports.AiMarketplaceOffersCreate = AiMarketplaceOffersCreate;
