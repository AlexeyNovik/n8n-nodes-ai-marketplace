...
exports.AiMarketplaceOffersComplete = void 0;
const n8n_workflow_1 = require("n8n-workflow");
class AiMarketplaceOffersComplete {
    constructor() {
        this.description = {
            displayName: 'Marketplace Offers: Complete',
            name: 'aiMarketplaceOffersComplete',
            icon: 'file:aimarketplace.svg',
            group: ['output'],
            version: 1,
            subtitle: '=Complete offer',
            description: 'Mark an offer as completed (seller only)',
            defaults: {
            ...
            properties: [
                ...
                },
                {
                    ...
                    required: true,
                    default: '',
                    description: 'The ID of the offer to mark as completed',
                },
                {
                    displayName: 'Timeout',
                    name: 'timeout',
                ...
                while (retryCount <= maxRetries) {
                    try {
                        response = await this.helpers.requestWithAuthentication.call(this, 'aiMarketplaceApi', {
                            method: 'POST',
                            url: `${baseUrl}/offers-v2/${encodeURIComponent(id)}/complete`,
                            headers,
...
exports.AiMarketplaceOffersComplete = AiMarketplaceOffersComplete;
