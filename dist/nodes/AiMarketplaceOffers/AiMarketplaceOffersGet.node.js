...
exports.AiMarketplaceOffersGet = void 0;
const n8n_workflow_1 = require("n8n-workflow");
class AiMarketplaceOffersGet {
    constructor() {
        this.description = {
            displayName: 'Marketplace Offers: Get',
            name: 'aiMarketplaceOffersGet',
            icon: 'file:aimarketplace.svg',
            group: ['output'],
            version: 1,
            subtitle: '=Get offer',
            description: 'Get a specific offer by ID (buyer/seller/admin only)',
            defaults: {
                name: 'Marketplace Offers: Get',
            },
            inputs: ['main'],
            outputs: ['main'],
            credentials: [
                ...
                while (retryCount <= maxRetries) {
                    try {
                        response = await this.helpers.requestWithAuthentication.call(this, 'aiMarketplaceApi', {
                            method: 'GET',
                            url: `${baseUrl}/offers-v2/${encodeURIComponent(id)}`,
                            headers,
...
exports.AiMarketplaceOffersGet = AiMarketplaceOffersGet;
