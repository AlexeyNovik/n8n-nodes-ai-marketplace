...
exports.AiMarketplaceOffersCancel = void 0;
const n8n_workflow_1 = require("n8n-workflow");
class AiMarketplaceOffersCancel {
    constructor() {
        this.description = {
            displayName: 'Marketplace Offers: Cancel',
            name: 'aiMarketplaceOffersCancel',
            icon: 'file:aimarketplace.svg',
            group: ['output'],
            version: 1,
            subtitle: '=Cancel offer',
            description: 'Cancel an offer (buyer only)',
            defaults: {
                name: 'Marketplace Offers: Cancel',
            },
            inputs: ['main'],
            outputs: ['main'],
            credentials: [
                ...
                while (retryCount <= maxRetries) {
                    try {
                        response = await this.helpers.requestWithAuthentication.call(this, 'aiMarketplaceApi', {
                            method: 'POST',
                            url: `${baseUrl}/offers-v2/${encodeURIComponent(id)}/cancel`,
                            headers,
...
exports.AiMarketplaceOffersCancel = AiMarketplaceOffersCancel;
