...
exports.AiMarketplaceOffersReject = void 0;
const n8n_workflow_1 = require("n8n-workflow");
class AiMarketplaceOffersReject {
    constructor() {
        this.description = {
            displayName: 'Marketplace Offers: Reject',
            name: 'aiMarketplaceOffersReject',
            icon: 'file:aimarketplace.svg',
            group: ['output'],
            version: 1,
            subtitle: '=Reject offer',
            description: 'Reject an offer (seller only)',
            defaults: {
                name: 'Marketplace Offers: Reject',
            },
            inputs: ['main'],
            outputs: ['main'],
            credentials: [
            ...
            properties: [
                ...
                },
                {
                    ...
                    required: true,
                    default: '',
                    description: 'The ID of the offer to reject',
                },
                {
                    displayName: 'Timeout',
                    name: 'timeout',
                ...
                while (retryCount <= maxRetries) {
                    try {
                        response = await this.helpers.requestWithAuthentication.call(this, 'aiMarketplaceApi', {
                            method: 'POST',
                            url: `${baseUrl}/offers-v2/${encodeURIComponent(id)}/reject`,
                            headers,
...
exports.AiMarketplaceOffersReject = AiMarketplaceOffersReject;
