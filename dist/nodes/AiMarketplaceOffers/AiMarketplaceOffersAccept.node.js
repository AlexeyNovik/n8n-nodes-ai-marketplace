...
exports.AiMarketplaceOffersAccept = void 0;
const n8n_workflow_1 = require("n8n-workflow");
class AiMarketplaceOffersAccept {
    constructor() {
        this.description = {
            displayName: 'Marketplace Offers: Accept',
            name: 'aiMarketplaceOffersAccept',
            icon: 'file:aimarketplace.svg',
            group: ['output'],
            version: 1,
            subtitle: '=Accept offer',
            description: 'Accept an offer (seller only)',
            defaults: {
                name: 'Marketplace Offers: Accept',
            },
            inputs: ['main'],
            outputs: ['main'],
            credentials: [
                ...
                while (retryCount <= maxRetries) {
                    try {
                        response = await this.helpers.requestWithAuthentication.call(this, 'aiMarketplaceApi', {
                            method: 'POST',
                            url: `${baseUrl}/offers-v2/${encodeURIComponent(id)}/accept`,
                            headers,
...
exports.AiMarketplaceOffersAccept = AiMarketplaceOffersAccept;
