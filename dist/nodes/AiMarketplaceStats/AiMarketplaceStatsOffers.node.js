...
exports.AiMarketplaceStatsOffers = void 0;
const n8n_workflow_1 = require("n8n-workflow");
class AiMarketplaceStatsOffers {
    constructor() {
        this.description = {
            displayName: 'Marketplace Stats: Offers',
            name: 'aiMarketplaceStatsOffers',
            icon: 'file:aimarketplace.svg',
            group: ['output'],
            version: 1,
            subtitle: '=Get offer statistics',
            description: 'Get total count of offers',
            defaults: {
                name: 'Marketplace Stats: Offers',
            },
            inputs: ['main'],
            outputs: ['main'],
            properties: [
...
exports.AiMarketplaceStatsOffers = AiMarketplaceStatsOffers;
