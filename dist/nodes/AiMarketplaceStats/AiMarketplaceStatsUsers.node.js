...
exports.AiMarketplaceStatsUsers = void 0;
const n8n_workflow_1 = require("n8n-workflow");
class AiMarketplaceStatsUsers {
    constructor() {
        this.description = {
            displayName: 'Marketplace Stats: Users',
            name: 'aiMarketplaceStatsUsers',
            icon: 'file:aimarketplace.svg',
            group: ['output'],
            version: 1,
            subtitle: '=Get user statistics',
            description: 'Get total count of registered users',
            defaults: {
                name: 'Marketplace Stats: Users',
            },
            inputs: ['main'],
            outputs: ['main'],
            properties: [
...
exports.AiMarketplaceStatsUsers = AiMarketplaceStatsUsers;
