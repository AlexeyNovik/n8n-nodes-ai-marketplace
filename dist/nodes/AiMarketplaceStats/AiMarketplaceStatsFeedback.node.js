...
exports.AiMarketplaceStatsFeedback = void 0;
const n8n_workflow_1 = require("n8n-workflow");
class AiMarketplaceStatsFeedback {
    constructor() {
        this.description = {
            displayName: 'Marketplace Stats: Feedback',
            name: 'aiMarketplaceStatsFeedback',
            icon: 'file:aimarketplace.svg',
            group: ['output'],
            version: 1,
            subtitle: '=Get feedback statistics',
            description: 'Get total count of feedback entries',
            defaults: {
                name: 'Marketplace Stats: Feedback',
            },
            inputs: ['main'],
            outputs: ['main'],
            properties: [
...
exports.AiMarketplaceStatsFeedback = AiMarketplaceStatsFeedback;
