...
exports.AiMarketplaceLotsGet = void 0;
const n8n_workflow_1 = require("n8n-workflow");
class AiMarketplaceLotsGet {
    constructor() {
        this.description = {
            displayName: 'Marketplace Lots: Get',
            name: 'aiMarketplaceLotsGet',
            ...
            properties: [
                ...
                },
                {
                    ...
                    required: true,
                    default: '',
                    description: 'The ID of the lot to retrieve',
                },
                {
                    displayName: 'Timeout',
                    name: 'timeout',
                ...
                while (retryCount <= maxRetries) {
                    try {
                        response = await this.helpers.request({
                            method: 'GET',
                            url: `${baseUrl}/lots-v2/${encodeURIComponent(id)}`,
                            headers,
...
exports.AiMarketplaceLotsGet = AiMarketplaceLotsGet;
