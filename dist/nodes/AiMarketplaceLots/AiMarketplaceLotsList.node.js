...
exports.AiMarketplaceLotsList = void 0;
const n8n_workflow_1 = require("n8n-workflow");
class AiMarketplaceLotsList {
    constructor() {
        this.description = {
            displayName: 'Marketplace Lots: List',
            name: 'aiMarketplaceLotsList',
            icon: 'file:aimarketplace.svg',
            group: ['output'],
            version: 1,
            subtitle: '=List lots',
            description: 'List all lots in the marketplace',
            defaults: {
                name: 'Marketplace Lots: List',
            },
            inputs: ['main'],
            outputs: ['main'],
            properties: [
                ...
                {
                    displayName: 'Client Side Limit',
                    name: 'clientSideLimit',
                    type: 'number',
                    default: 20,
                    typeOptions: {
                        minValue: 1,
                    ...
                    description: 'Client-side limit for MCP compatibility (1-50, default 20)',
                },
                {
                    displayName: 'Timeout',
                    name: 'timeout',
    ...
    async execute() {
        ...
        for (let i = 0; i < items.length; i++) {
            try {
                ...
                const clientSideLimit = this.getNodeParameter('clientSideLimit', i);
                ...
                // Apply client-side limit for MCP compatibility
                if (responseFormat === 'json' && (response === null || response === void 0 ? void 0 : response.lots) && Array.isArray(response.lots) && clientSideLimit) {
                    response.lots = response.lots.slice(0, clientSideLimit);
                }
                returnData.push({
...
exports.AiMarketplaceLotsList = AiMarketplaceLotsList;
