...
exports.AiMarketplaceLotsClose = void 0;
const n8n_workflow_1 = require("n8n-workflow");
class AiMarketplaceLotsClose {
    constructor() {
        this.description = {
            displayName: 'Marketplace Lots: Close',
            name: 'aiMarketplaceLotsClose',
            ...
            properties: [
                ...
                },
                {
                    ...
                    required: true,
                    default: '',
                    description: 'The ID of the lot to close',
                },
                {
                    displayName: 'Timeout',
                    name: 'timeout',
                ...
                while (retryCount <= maxRetries) {
                    try {
                        response = await this.helpers.requestWithAuthentication.call(this, 'aiMarketplaceApi', {
                            method: 'POST',
                            url: `${baseUrl}/lots-v2/${encodeURIComponent(id)}/close`,
                            headers,
...
exports.AiMarketplaceLotsClose = AiMarketplaceLotsClose;
