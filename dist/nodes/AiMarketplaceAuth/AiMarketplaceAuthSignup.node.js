...
exports.AiMarketplaceAuthSignup = void 0;
const n8n_workflow_1 = require("n8n-workflow");
class AiMarketplaceAuthSignup {
    constructor() {
        this.description = {
            displayName: 'Marketplace Auth: Signup',
            name: 'aiMarketplaceAuthSignup',
            icon: 'file:aimarketplace.svg',
            group: ['output'],
            version: 1,
            subtitle: '=Sign up new user',
            description: 'Register a new user in the AI Marketplace',
            defaults: {
                name: 'Marketplace Auth: Signup',
            },
            inputs: ['main'],
            outputs: ['main'],
            properties: [
...
exports.AiMarketplaceAuthSignup = AiMarketplaceAuthSignup;
