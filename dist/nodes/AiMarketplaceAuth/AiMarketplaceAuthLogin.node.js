...
exports.AiMarketplaceAuthLogin = void 0;
const n8n_workflow_1 = require("n8n-workflow");
class AiMarketplaceAuthLogin {
    constructor() {
        this.description = {
            displayName: 'Marketplace Auth: Login',
            name: 'aiMarketplaceAuthLogin',
    ...
    async execute() {
        ...
        for (let i = 0; i < items.length; i++) {
            try {
                ...
                // Add sessionToken alias for MCP compatibility as per SOW-2.md
                if (responseFormat === 'json' && (response === null || response === void 0 ? void 0 : response.accessToken)) {
...
exports.AiMarketplaceAuthLogin = AiMarketplaceAuthLogin;
