...
exports.AiMarketplaceCategoriesList = void 0;
const n8n_workflow_1 = require("n8n-workflow");
class AiMarketplaceCategoriesList {
    constructor() {
        this.description = {
            displayName: 'Marketplace Categories: List',
            name: 'aiMarketplaceCategoriesList',
            icon: 'file:aimarketplace.svg',
            group: ['output'],
            version: 1,
            subtitle: '=List categories',
            description: 'List all available categories with names, IDs, and descriptions',
            defaults: {
...
exports.AiMarketplaceCategoriesList = AiMarketplaceCategoriesList;
