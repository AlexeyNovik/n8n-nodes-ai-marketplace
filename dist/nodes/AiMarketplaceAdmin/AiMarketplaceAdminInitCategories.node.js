...
exports.AiMarketplaceAdminInitCategories = void 0;
const n8n_workflow_1 = require("n8n-workflow");
class AiMarketplaceAdminInitCategories {
    constructor() {
        this.description = {
            displayName: 'Marketplace Admin: Init Categories',
            name: 'aiMarketplaceAdminInitCategories',
            icon: 'file:aimarketplace.svg',
            group: ['output'],
            version: 1,
            subtitle: '=Initialize categories',
            description: 'Initialize default categories for testing purposes',
            defaults: {
                name: 'Marketplace Admin: Init Categories',
            },
            inputs: ['main'],
            outputs: ['main'],
            properties: [
                ...
                while (retryCount <= maxRetries) {
                    try {
                        response = await this.helpers.request({
                            method: 'POST',
                            url: `${baseUrl}/admin-v2/init-categories`,
                            headers,
...
exports.AiMarketplaceAdminInitCategories = AiMarketplaceAdminInitCategories;
